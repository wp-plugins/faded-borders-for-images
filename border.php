...
License: GPL2
    ...
    Copyright 2011 David Cox  (email : david@cookonashoestring.com)
...
//		wp_register_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js', false, '1.5.2');
		...
		wp_enqueue_script('my_script', bloginfo('url') . '/wp-content/plugins/gradient-border/border.js', array('jquery'));
	}
}
